...
_OBJ = string.o syscalls.o printf.o fileio.o alloc.o start.o dirent.o rand.o errno.o qsort.o unistd.o fcntl.o termios_attr.o atexit.o ctype.o tty_fg.o stdio.o environ.o
